...
├── src/UltimateWardrobe.Mapping     # (Phase 3) manual mapping + patch detection + status/progress (Sprints 3.0-3.2 done - CRUD/validation + patch detection; Core 3.0.2 amendment: PatchPolicy + Overhaul.Policy)
