...
├── src/UltimateWardrobe.Persistence # Phase 4 SQLite (Sprints 4.0-4.2 done - project + Microsoft.Data.Sqlite + ProjectDatabase WAL/foreign_keys bootstrap + Migrator/M001_Initial schema + .bak backup + UnitOfWork + RowCodecs + 5 repositories + PersistenceJson row codecs; Core 4.0.2 amendment: Overhaul.CreatedAt/ModifiedAt)
