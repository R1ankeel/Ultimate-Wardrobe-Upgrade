...
├── src/UltimateWardrobe.DonorLibrary# Phase 2 donor classification (branches 1-3 done; service in Sprint 2.4)
...
- `Docs/donor-library.md` - donor import + graduated classification (Phase 2, Sprints 2.0-2.3 done)
