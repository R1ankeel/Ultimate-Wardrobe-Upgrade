...
├── src/UltimateWardrobe.Patcher     # ESP patcher + file slicer (Phase 5, Sprints 5.0-5.2 done)
...
- `Plans/phase0.md`, `Plans/phase1.md`, `Plans/phase2.md`, `Plans/phase3.md`, `Plans/phase4.md`, `Plans/phase5.md` - implementation plans (phases 1, 2, 3, 4 done; phase 5 in progress, Sprints 5.0-5.2 done)
...
- `Docs/patcher.md` - ESP patcher: target resolution + `PluginBuilder` override records + ESL gate + amendment #6 loose-path skip + `FileSlicer`/`DonorFileLocator` whitelist slice + patch overlay + dedup + Core `IPatcher`/`PatchReport` amendment (Phase 5, Sprints 5.0-5.2 done; orchestrator + `meta.ini` documented in Sprint 5.3)
