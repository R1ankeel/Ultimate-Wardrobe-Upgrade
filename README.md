...
- Phase 5 - ESP patcher + file slicer + orchestrator: in progress (Sprints 5.0-5.4, see `Plans/phase5.md`)
...
├── src/UltimateWardrobe.Patcher     # ESP patcher + file slicer + orchestrator (Phase 5, Sprints 5.0-5.3 done)
...
- `Plans/phase0.md`, `Plans/phase1.md`, `Plans/phase2.md`, `Plans/phase3.md`, `Plans/phase4.md`, `Plans/phase5.md` - implementation plans (phases 1, 2, 3, 4 done; phase 5 in progress, Sprints 5.0-5.3 done)
